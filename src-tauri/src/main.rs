...
fn main() {
  ...
  let tauri_setup = tauri::Builder::default()
    ...
    .invoke_handler(tauri::generate_handler![
      ...
      commands::config::cleanup_mod_enabled_texture_packs,
      ...
      commands::config::set_mod_texture_packs,
